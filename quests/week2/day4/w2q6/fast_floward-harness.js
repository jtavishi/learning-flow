  ...
  render() {
    let content = html`
      <page-body title="${this.title}" category="${this.category}" description="${this.description}">
        ...
        <action-card title="DAY 4: Kitty Items Market - Sell Market Item" action="kittyItemsMarketSellMarketItem" method="post"
          fields="signer itemID price" description="Sell market item from the marketplace">
          <account-widget field="signer" label="Signer">
          </account-widget>
          <text-widget field="itemID" label="Item ID" placeholder="0"></text-widget>
          <text-widget field="price" label="Amount" placeholder="10.0"></text-widget>
        </action-card>
        ...
        <action-card title="DAY 4: Kitty Items Market - Buy Market Item" description="Buy a Kitty Item from the Marketplace" action="kittyItemsMarketBuyMarketItem" method="post"
          ...
          <text-widget field="itemID" label="Item ID" placeholder="0"></text-widget>
          <account-widget field="marketCollectionAddress" label="From">
          </account-widget>
        </action-card>
        ...
        <action-card title="DAY 4: Kitty Items Market - Read Sale Collection IDs" action="kittyItemsMarketReadSaleCollectionIDs" method="get"
          fields="marketCollectionAddress" description="Get sale collection ids from the Marketplace">
          <account-widget field="marketCollectionAddress" label="From">
          </account-widget>
        </action-card>
